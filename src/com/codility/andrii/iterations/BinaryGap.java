...
a binary gap of length 2. The number 529 has binary representation 1
000010001 and contains two binary gaps: one of length 4 and one of 
...
public class BinaryGap {
	...
	public static void main(String[] args) {
		...
		for( int n : tst) {
			System.out.printf("N = %5d, result = %5d\n", n, sol.solution(n));
		}

	}
	
	/* --------------------------
	 * Find a maximum quantity of zeros in a row in a binary representation of a number 
	*/
